...
19 y/o · 2nd Year B.Sc. (Hons) Electronics @ Hansraj College, Delhi University
Exploring **Embedded Systems**, **Robotics**, and **VLSI** — I like building things that blink, move, or sense the world, then documenting how they came together.
...
|---|---|---|
| [Ultrasonic Radar](https://github.com/maheswar-eltro/ultrasonic-radar) | Servo-mounted radar with real-time object detection, visualized live in Processing | Arduino · C/C++ · Processing · Serial Comm |
...
`Arduino` `ESP32` `Python` `C/C++` `OpenCV` `Processing` `Embedded Systems`
 
## Reach me
LinkedIn - https://www.linkedin.com/in/maheswar-sibi-a377a2391/
Feel free to check out a repo, open an issue, or just say hi.
